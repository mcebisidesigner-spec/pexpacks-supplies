...
export const SYSTEM_SETTING_DEFINITIONS: SystemSettingDefinition[] = [
  ...
  { key: "business.support_email", category: "business", label: "Customer Support Email", description: "Primary public customer service email address", valueType: "email", scope: "global", isSensitive: false, isPublic: true, requiresApproval: false, defaultValue: "care@pexpacks.co.za" },
