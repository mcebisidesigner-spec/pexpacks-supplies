...
export const officePacks: OfficePack[] = [
  {
    ...
    priceFrom: 449,
    contents: ["Notebook set", "Ballpoint pens", "Pencils", "Sticky notes", "Correction tape", "Filing basics"]
  },
  {
    id: "small-business-monthly",
    name: "Small Business Monthly Pack",
    slug: "small-business-monthly-pack",
    description: "A monthly refill pack for small teams that need consistent stationery basics.",
    priceFrom: 899,
    contents: ["Pens", "Notebooks", "Sticky notes", "Folders", "Markers", "Desk basics"]
  },
  {
    id: "bulk-office-supply",
    name: "Construction Admin Pack",
    slug: "construction-admin-pack",
    description: "A quote-based admin pack for site files, job cards, markers and office basics.",
    priceFrom: 0,
    contents: ["Job-card books", "Pens", "Markers", "Files", "Labels", "Clipboards"]
  },
  {
    id: "retail-shop-admin",
    name: "Retail Shop Admin Pack",
    slug: "retail-shop-admin-pack",
    description: "Stationery and counter basics for small shops that need simple monthly replenishment.",
    priceFrom: 0,
    contents: ["Receipt books", "Pens", "Labels", "Price tags", "Tape", "Notebooks"]
  },
  {
