...
export function PartnershipHero({
  ...
  return (
    <section className="py-12 sm:py-20" aria-labelledby="partnership-hero-title">
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 min-[981px]:grid-cols-[minmax(0,1.15fr)_minmax(320px,0.9fr)] gap-10 min-[981px]:gap-[clamp(32px,5vw,68px)] items-center">
          <div className="flex flex-col items-start">
            <p className="mb-3 text-pex-keppel text-sm font-extrabold text-left">
              {eyebrow}
            </p>

            <h1 id="partnership-hero-title" className="m-0 mb-5 text-pex-navy font-heading text-[clamp(36px,5.2vw,64px)] font-extrabold leading-[1.04] tracking-[-0.02em]">
              {title}
            </h1>

            <p className="m-0 mb-[18px] text-slate-700 text-[clamp(16px,1.8vw,18.5px)] leading-[1.55] font-medium">
              Transform seasonal back-to-school administration into an automated
              revenue generator for your campus.
            </p>

            <p className="m-0 mb-8 text-slate-600 text-[clamp(14px,1.5vw,15.5px)] leading-[1.6]">
            ...
            <div className="flex flex-wrap gap-2.5 mb-[34px]" aria-label="Partnership guarantees">
              <div className="inline-flex items-center gap-1.5 py-1.5 px-3.5 rounded-full bg-white border border-slate-200/80 text-pex-navy text-[13px] font-bold shadow-[0_2px_8px_rgba(26,42,64,0.04)]">
                <span className="text-pex-keppel inline-flex">
                  <ShieldCheck size={16} />
                </span>
