...
import styles from "./BookCoveringBanner.module.css";
import { Button } from "@/components/ui/Button";

export function BookCoveringBanner() {
  return (
    <section
      className={styles.bookCoveringBanner}
      aria-labelledby="book-covering-heading"
    >
      <div className={styles.bookCoveringInner}>
        <div className={styles.bookCoveringContent}>
          ...
          <h2 id="book-covering-heading">
            Hate covering books? We'll do it for you.
          </h2>
          <p className={styles.bookCoveringLead}>
            Skip the late-night plastic wrap battles. Add our{" "}
            <strong>Full Preparation Service</strong> at checkout and receive
            your pack 100% classroom-ready.
          </p>
