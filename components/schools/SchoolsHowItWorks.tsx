      ...
      <div className="flex flex-wrap sm:flex-nowrap items-center justify-center gap-1.5 sm:gap-3 p-3 sm:py-3.5 sm:px-5 rounded-card bg-card border border-pex-border shadow-card">
        <div className="flex items-center gap-2.5 min-w-0">
          ...
          <div className="flex flex-col gap-px">
            <span className="text-xs sm:text-[13px] font-extrabold text-pex-navy leading-[1.2] whitespace-nowrap">
              Find your school
            </span>
            <span className="hidden md:block text-[11px] text-pex-muted leading-[1.3] whitespace-nowrap">
              Search our directory of SA schools
            </span>
          </div>
        </div>
        <div className="hidden sm:grid shrink-0 text-pex-border place-items-center">
