-- Migration 00050: Update get_all_pack_school_groups_json to return active_packs_count and stationery_items_count per school
      ...
      (
        select jsonb_agg(
          jsonb_build_object(
            ...
            'stationery_items_count', vf.stationery_items_count,
