-- Reconcile the deployed payment-completion function with the tracked definition.
-- The allocation call is retained for its side effect; its integer return value is intentionally discarded.
