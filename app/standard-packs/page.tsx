  ...
  return (
    <>
      <section className={pageStyles.pageHero}>
        <div className={pageStyles.pageHeroNarrow}>
          ...
          <p className={pageStyles.pageHeroText}>
            Can&apos;t find your specific school list? Our standard phase packs
            are pre-configured with 90% of the typical items required by South
            African curriculums for each grade phase.
          </p>
        </div>
      </section>
      ...
      <section
        ...
        aria-labelledby="standard-packs-heading"
      >
          ...
          <div className={pageStyles.cardGrid}>
            {homepagePacks.map((pack) => (
              <PackCard
                ...
                pack={{
                  ...pack,
                  href: `/order?generic=true&phase=${pack.subcategory}`,
                  cta: "Order this pack",
                }}
              />
            ))}
      ...
      >
        <div className={styles.howItWorksInner}>
          <div className={styles.sectionIntro}>
            ...
            <span>
              If you don't have time to wait for a custom school list, our
              standard packs cover the essentials.{" "}
              <strong>
          ...
          <div className={styles.howItWorksGrid}>
            <div className={styles.howItWorksStep}>
              ...
              <p>
                Select Foundation, Primary, or High School based on your child's
                age.
              </p>
            </div>
            <div className={styles.howItWorksStep}>
              ...
              <p>
                Each box is packed with standard curriculum-approved pens,
                pencils, glue, and books.
              </p>
            </div>
            <div className={styles.howItWorksStep}>
