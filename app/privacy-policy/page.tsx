...
const privacySections = [
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Pexpacks Supplies respects your privacy and is committed to protecting
          your personal information in accordance with the{" "}
          <strong>Protection of Personal Information Act, 4 of 2013 (POPIA)</strong>,
          the <strong>Promotion of Access to Information Act, 2 of 2000 (PAIA)</strong>,
          the{" "}
          <strong>Electronic Communications and Transactions Act, 25 of 2002 (ECTA)</strong>,
          the <strong>Consumer Protection Act, 68 of 2008 (CPA)</strong>, and
          other applicable South African laws.
        </p>
        <p>
          This Privacy Policy explains how we collect, use, store, share,
          protect, and delete personal information when you use our website, web
          app, online forms, order system, communication channels, social media
          pages, customer support platforms, delivery services, and related
          services.
        </p>
        <p>
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p>
          We may collect your full name, email address, mobile number, physical
          and delivery address, order details, payment status, communication
          preferences, and device/browser usage information.
        </p>
        <h3>Learner-related information</h3>
        <p>
          Where Pexpacks provides school stationery packs or Pexcover services,
          we may collect limited learner-related information where necessary,
          such as learner name, grade, school name, stationery list
        ...
        <p>
          We collect order totals, payment references, IP addresses, and cookies
          to ensure website security and order processing. We do not store full
    ...
    content: (
      <>
        ...
        <p>
          ...
          keep the website running smoothly, enable account functionalities, and
          analyse website traffic. You can control cookies through your browser
          settings.
        </p>
      </>
    ),
    ...
    content: (
      <>
        ...
        <p>
          ...
          information securely. <strong>We do not sell personal information.</strong>
        </p>
      </>
    ),
  },
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p>
          If you believe your information has been processed unlawfully, please
          contact us first. You also have the right to lodge a complaint with
          the <strong>Information Regulator of South Africa</strong> at{" "}
          <a
  ...
  return (
    <>
      <PageHero
        ...
        title="How Pexpacks handles your information"
        text="A clear guide to what we collect, why we collect it, who we share it with, and how you can contact us about your personal information."
        panelTitle="POPIA Aligned"
        panelText="Effective May 2026, South Africa"
      />
        ...
        <div className={`${page.sectionInner} ${styles.policyInner}`}>
          ...
          <div className={styles.policyContent}>
            <div className={styles.summaryPanel}>
              <p className={styles.summaryKicker}>Quick privacy contact</p>
              <h2>Need help with your data?</h2>
              <p>
                Email <a href={generalEmailHref}>{generalEmail}</a> or call{" "}
                <a href={phoneHref}>{phoneNumber}</a>. We will route privacy
                requests to the Pexpacks Privacy Officer.
              </p>
            </div>
