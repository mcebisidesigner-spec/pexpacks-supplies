        ...
        <div className={sectionStyles.inner}>
          <div className={sectionStyles.splitBand}>
            <div>
              ...
              <h2>Other phases</h2>
              <p>
                Need stationery for an older or younger learner? Browse packs for every grade level.
              </p>
              <div className={sectionStyles.buttonRow}>
                <Button href="/primary-school" variant="primary">Primary School Packs</Button>
