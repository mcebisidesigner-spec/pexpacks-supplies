...
export default async function HomePage() {
  ...
  return (
    <>
      <section
        id="home-hero"
        className="bg-[var(--pex-navy)] pt-[clamp(36px,6vw,52px)] pb-[clamp(44px,8vw,72px)] md:pt-[clamp(52px,8vw,96px)] md:pb-[clamp(58px,8vw,108px)]"
      >
        <div className="w-full max-w-[var(--layout-max-width)] mx-auto px-4 md:px-8 grid grid-cols-1 lg:grid-cols-[minmax(0,1.05fr)_minmax(360px,0.95fr)] items-center gap-[clamp(38px,6vw,76px)]">
          <div className="min-w-0">
            ...
            <h1 className="m-0 text-white font-[family-name:var(--font-heading)] text-[clamp(36px,16vw,42px)] sm:text-[clamp(40px,10.7vw,44px)] lg:text-[clamp(42px,6.4vw,76px)] font-extrabold leading-[1.02] lg:leading-[0.98] tracking-normal break-normal lg:break-words">
          ...
          <div className="relative min-h-[390px] md:min-h-[440px] lg:min-h-[560px] rounded-[var(--radius-card)] lg:rounded-[30px] overflow-hidden bg-[linear-gradient(135deg,rgba(26,42,64,0.94),rgba(21,34,56,0.88))] shadow-[0_28px_70px_rgba(26,42,64,0.18)] lg:[animation:floatAnimation_6s_ease-in-out_infinite] transition-transform duration-300 motion-reduce:animate-none min-w-0">
      ...
      <div
        className="overflow-hidden bg-[var(--pex-bg-soft)] py-[18px] border-y border-[var(--pex-border)]"
        aria-hidden="true"
      >
      ...
      <section
        id="social-proof"
        className="py-[var(--section-padding-y-mobile)] sm:py-[var(--section-padding-y-tablet)] lg:py-[var(--section-padding-y-desktop)] bg-gradient-to-b from-[var(--pex-bg)] to-[var(--pex-bg-soft)]"
        aria-labelledby="home-social-proof-heading"
      >
        <div className="w-full max-w-[var(--layout-max-width)] mx-auto px-4 md:px-8">
          <div className="overflow-hidden border border-[var(--color-navy-subtle)] rounded-[28px] lg:rounded-[var(--radius-section)] bg-[radial-gradient(circle_at_94%_12%,rgba(255,111,89,0.16),transparent_32%),var(--pex-bg)] shadow-[0_24px_70px_rgba(26,42,64,0.1)] grid grid-cols-1 lg:grid-cols-[minmax(0,1.08fr)_minmax(320px,0.78fr)] items-stretch p-0">
            <div className="relative min-h-0 aspect-[1.25/1] lg:min-h-[clamp(360px,44vw,560px)] lg:aspect-auto overflow-hidden bg-[var(--pex-bg-soft)] after:content-[''] after:absolute after:inset-x-0 after:bottom-0 after:h-[28%] lg:after:h-[36%] after:bg-gradient-to-b after:from-transparent after:to-[rgba(26,42,64,0.24)] lg:after:to-[rgba(26,42,64,0.48)] after:pointer-events-none">
              <Image
              ...
              />
              <div
                className="absolute left-6 bottom-3.5 lg:left-[clamp(18px,3vw,34px)] lg:bottom-[clamp(18px,3vw,34px)] z-1 w-[78px] h-[78px] lg:w-[138px] lg:h-[138px] rounded-full border border-white/60 bg-white/90 text-[var(--pex-navy)] grid place-items-center content-center text-center shadow-[0_10px_24px_rgba(26,42,64,0.16)] lg:shadow-[0_16px_36px_rgba(26,42,64,0.18)] backdrop-blur-[10px]"
                aria-label="Trusted parent validation"
              >
                <strong className="font-[family-name:var(--font-heading)] text-[23px] lg:text-[34px] leading-none block">
                  100%
                </strong>
                <span className="max-w-[58px] lg:max-w-[90px] text-[var(--pex-keppel)] text-[8px] lg:text-[11px] font-black leading-[1.15] uppercase block">
                  List match promise
                </span>
              </div>
            </div>
            ...
            <div className="relative p-[clamp(24px,6vw,38px)] lg:p-[clamp(30px,5vw,62px)] grid content-center">
              <p className="m-0 mb-3 text-[var(--section-eyebrow-color)] font-extrabold text-[var(--section-eyebrow-font-size)] tracking-[var(--section-eyebrow-letter-spacing)]">
                Parent validation
              </p>
              <h2
                id="home-social-proof-heading"
                className="m-0 text-[var(--pex-navy)] font-[family-name:var(--font-heading)] text-[clamp(28px,12vw,38px)] lg:text-[clamp(34px,4.5vw,62px)] font-extrabold leading-[0.98] tracking-normal"
              >
                Real packs. Real schools. Real peace of mind.
              </h2>
              {featuredTestimonial ? (
                <>
                  <blockquote className="relative mt-[clamp(24px,4vw,38px)] p-[clamp(20px,3vw,28px)] border border-[rgba(255,111,89,0.22)] rounded-[22px] lg:rounded-[28px] bg-[linear-gradient(135deg,rgba(255,111,89,0.1),var(--color-teal-subtle)),var(--pex-bg)] text-[var(--pex-primary)] font-[family-name:var(--font-heading)] text-[clamp(20px,7vw,26px)] lg:text-[clamp(21px,2.4vw,31px)] font-extrabold leading-[1.16] shadow-[0_16px_34px_rgba(26,42,64,0.06)] before:content-['“'] before:absolute before:-top-[26px] before:right-[22px] before:text-[rgba(255,111,89,0.26)] before:font-serif before:text-[110px] before:leading-none">
                    &ldquo;{featuredTestimonial.quote}&rdquo;
                  </blockquote>
                  <p className="mt-4 text-[var(--pex-keppel)] text-[15px] font-black">
              ...
              >
                <span className="inline-flex items-center min-h-[38px] px-3.5 py-2 border border-[var(--color-teal-border)] rounded-full bg-[var(--color-teal-subtle)] text-[var(--pex-primary)] text-xs font-black">
