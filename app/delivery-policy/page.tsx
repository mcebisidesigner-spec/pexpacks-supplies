...
export const metadata: Metadata = buildMetadata(
  "Delivery Policy",
  "Read the Pexpacks Supplies delivery policy for school stationery packs and office stationery packs.",
  "/delivery-policy"
);
      ...
      <section className={page.pageHero}>
        <div className={page.pageHeroNarrow}>
          ...
          <p className={page.pageHeroText}>
            Pexpacks Supplies confirms delivery and collection details after receiving the selected school, grade, pack, and
