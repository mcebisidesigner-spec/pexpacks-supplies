    ...
    <>
      ...
      >
        <div className={sectionStyles.buttonRow}>
          ...
          <Button href="#how-it-works" variant="white">How It Works</Button>
        </div>
      </PageHero>
      ...
      <section className={sectionStyles.section}>
        <div className={sectionStyles.inner}>
          <div className={sectionStyles.splitBand}>
            <div>
              <p className={sectionStyles.sectionEyebrow}>Everything included</p>
              <h2>Your school gets a complete online presence — at no cost.</h2>
              <p>
                Designate Pexpacks as your official stationery partner and we build,
                host, and maintain a professional school website with a dedicated
                parent ordering portal. No invoices, no admin, no hidden fees.
              </p>
              <div className={sectionStyles.buttonRow}>
                <Button href="#partner-form" variant="primary">Apply to Partner</Button>
              </div>
      ...
      <section className={sectionStyles.sectionAlt} id="how-it-works">
        <div className={sectionStyles.inner}>
          ...
          <h2 style={{ margin: 0, fontSize: "clamp(32px, 4.6vw, 56px)", lineHeight: 1, fontWeight: 800 }}>
            Go live in 3 steps
          </h2>
          <p style={{ margin: "14px 0 34px", color: "var(--pex-text-muted)", fontSize: 18, lineHeight: 1.45 }}>
          ...
          <div style={{
            ...
            {steps.map((step, i) => (
              <div key={step.title} className={cardStyles.packCard} style={{ textAlign: "center" }}>
      ...
      <section className={sectionStyles.sectionAlt} id="partnership-faq">
        <div className={sectionStyles.inner}>
          ...
          <p style={{ margin: "14px 0 0", color: "var(--pex-text-muted)", fontSize: 18, lineHeight: 1.45 }}>
      ...
      <section className={sectionStyles.section} id="partner-form">
        <div className={sectionStyles.inner}>
          <div className={sectionStyles.splitBand}>
            <div>
              <p className={sectionStyles.sectionEyebrow}>Get started</p>
              <h2>Apply to partner</h2>
              <p>
                Complete the form and our team will reach out to discuss your
                school website, grade packs, and launch timeline.
              </p>
            </div>
            <PartnerForm />
          </div>
