...
<rss version="2.0" xmlns:g="http://base.google.com/ns/1.0" xmlns:atom="http://www.w3.org/2005/Atom">
  <channel>
    ...
    <link>${siteUrl}</link>
    <atom:link href="${siteUrl}/api/google-merchant-feed" rel="self" type="application/rss+xml" />
    <description>Official school stationery packs and grade-matched lists for South African schools (Merchant Center ID: 5838143471).</description>
    ${itemsXml}
  </channel>
</rss>`;
