...
export const metadata = {
  ...
  description: "Compose an official school price quotation with live line items and VAT.",
};
...
export default async function QuotationsPage() {
  ...
  // Fetch active schools for directory search
  ...
  // Fetch master products for autocomplete search
