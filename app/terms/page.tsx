...
const termsSections: TermsSection[] = [
  {
    ...
    content: (
      <dl className={styles.detailsList}>
        ...
        <div>
          <dt>WhatsApp</dt>
          <dd>{hasWhatsAppNumber ? whatsappNumber : "Available on request"}</dd>
        </div>
        <div>
          <dt>Business address</dt>
          <dd>Shared on request or on formal invoices and service documents.</dd>
        </div>
        <div>
          <dt>Registration and VAT</dt>
          <dd>Shared where applicable on quotations, invoices, or request.</dd>
        </div>
      </dl>
    ),
  },
  {
    ...
    content: (
      <>
        ...
        <ul>
          <li>You must be at least 18, or act with parent or guardian consent.</li>
          <li>You may place orders for a school, business, or organisation only if you are authorised to do so.</li>
          <li>Children may not place orders, create accounts, or submit personal information without proper adult or school authority.</li>
          <li>You may use the website and web app only for lawful purposes.</li>
        </ul>
      </>
    ),
  },
    ...
    content: (
      <>
        ...
        <ul>
          ...
          <li>Pexcover book covering, labelling, sorting, and pack preparation</li>
          <li>Office stationery packs, SME packs, and convenience packs</li>
          <li>Bulk supply solutions for schools and offices</li>
          <li>Online quote requests, online order submissions, and order management support</li>
          <li>School partnership programmes and related digital service offers</li>
          <li>Business support packs, branding support, and standard website or web app packages where offered</li>
        </ul>
        <p>
          ...
          accurately as reasonably possible, but some details may change because
          of supplier updates, school changes, seasonality, or stock movement.
        </p>
        <ul>
          <li>Images may be illustrative only and packaging may differ.</li>
          <li>Brands may vary unless a specific brand is confirmed in writing.</li>
          <li>School stationery requirements may change if the school updates its list.</li>
          <li>Pexpacks may offer substitutes, revised quotations, delays, partial refunds, or full refunds for unavailable items where appropriate.</li>
        </ul>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        ...
        <ul>
          <li>Schools may update their stationery requirements from time to time.</li>
          <li>Pexpacks may rely on information supplied by schools, parents, or authorised representatives.</li>
          <li>Pexpacks is not responsible for inaccurate third-party stationery lists.</li>
          <li>Specially assembled school packs may be treated as customised orders.</li>
        </ul>
        ...
        <ul>
          <li>Books may need to be delivered to, collected from, or dropped off at an agreed location.</li>
          <li>Delays caused by late book submission, missing books, inaccurate instructions, or school list changes are outside Pexpacks&apos; control.</li>
          <li>Once labour-based or customised work has started, cancellation rights may be limited except where law requires otherwise.</li>
          <li>Customers must ensure books are properly identified and handed over in good condition.</li>
        </ul>
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <ul>
          <li>An order is accepted only once Pexpacks confirms acceptance or begins fulfilment.</li>
          <li>Pexpacks may correct obvious pricing, typographical, calculation, or system errors before accepting an order.</li>
          <li>Pexpacks may decline or cancel an order if payment is missing, stock is unavailable, delivery is not possible, information is inaccurate, or the order appears fraudulent or unlawful.</li>
          <li>Customers must review their selection, quantities, delivery information, and payment details before final submission.</li>
        </ul>
        <p>
    ...
    content: (
      <>
        <p>
          ...
          Prices may include or exclude VAT depending on Pexpacks&apos; VAT status
          and the way the price is displayed.
        </p>
        <ul>
          <li>Quoted or displayed prices may exclude delivery, labour, customisation, urgent processing, or third-party service fees.</li>
          <li>Once a paid order is accepted, Pexpacks will not increase the price unless the customer requests a change, the original quote contained an obvious error, or the order requirements change.</li>
          <li>Orders are usually processed only after payment is received or approved, unless written account terms apply.</li>
          <li>Customers must use the correct payment reference to avoid fulfilment delays.</li>
        </ul>
        <p>Accepted payment methods may include EFT, online card payment, payment gateways, instant EFT, bank deposit, or other approved methods.</p>
        <p>
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <ul>
          <li>Delivery times are estimates unless expressly guaranteed in writing.</li>
          <li>Delays can result from incorrect delivery details, customer unavailability, courier issues, weather, supplier delays, strikes, school list changes, public holidays, or other events beyond reasonable control.</li>
          <li>Risk in goods may pass on delivery to the customer, agreed school collection point, authorised recipient, or customer collection, depending on the chosen fulfilment method.</li>
        </ul>
        <h3>School collection points</h3>
        <p>
          If Pexpacks delivers to a school collection point, the school may help
          with distribution but is not the seller unless expressly stated
          otherwise.
        </p>
        <ul>
          <li>Collection windows may be limited.</li>
          <li>Pexpacks may require proof of identity, order number, or payment confirmation.</li>
          <li>Items left uncollected after reasonable notice may be handled according to the applicable school or fulfilment arrangement.</li>
        </ul>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        ...
        <ul>
          <li>Consumers may have remedies where goods are defective, unsafe, not as described, supplied in error, or damaged before delivery.</li>
          <li>Returned goods may be inspected before a refund, replacement, repair, or exchange is approved.</li>
          <li>A return may be refused where goods were misused, altered, opened, written on, labelled, consumed, or damaged after delivery, unless they were defective.</li>
          <li>Custom, personalised, labelled, specially ordered, covered, printed, or learner-specific items may not be returnable merely because the customer changed their mind.</li>
        </ul>
        <p>
    ...
    content: (
      <>
        ...
        <ul>
          ...
          <li>Hosting periods, page limits, premium integrations, maintenance, renewals, and advanced development may be billed separately.</li>
          <li>Schools must provide accurate content, approvals, logos, images, and permissions.</li>
          <li>Any school, parent, learner, or order data will be handled only for the agreed purpose and in line with applicable privacy law.</li>
        </ul>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <h3>User accounts</h3>
        <ul>
          <li>Where accounts are available, you must provide accurate registration details and keep login credentials secure.</li>
          <li>You are responsible for activity performed through your account unless caused by Pexpacks&apos; proven negligence or unlawful conduct.</li>
          <li>Pexpacks may suspend or remove accounts that are inactive, duplicated, compromised, fraudulent, or abusive.</li>
        </ul>
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <ul>
          <li>Personal information may be processed for fulfilment, delivery, payment, customer support, legal compliance, and service improvement.</li>
          <li>Learner-related information is handled carefully and only for lawful, relevant operational purposes.</li>
          <li>Marketing messages may be sent where permitted by law and should include an opt-out option where required.</li>
        </ul>
        <p>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Pexpacks aims to keep the website and web app available, accurate, and
          secure, but does not guarantee uninterrupted or error-free access.
          Services may be affected by maintenance, hosting issues, internet
          failures, technical bugs, security incidents, or other provider-side
          disruptions.
        </p>
        <ul>
          <li>Pexpacks may correct website or system errors and revise affected orders before acceptance or fulfilment where lawful and reasonable.</li>
          <li>Nothing in these Terms excludes rights or remedies that cannot legally be excluded under South African law.</li>
          <li>To the maximum extent permitted by law, Pexpacks is not liable for indirect or consequential loss, including loss caused by customer error, third-party services, or events beyond reasonable control.</li>
          <li>Any direct liability relating to an order may, where lawful, be limited to the amount paid for the affected product or service.</li>
        </ul>
        <p>
          ...
          unrest, cyber incidents beyond reasonable control, supplier shortages,
          school closures, severe weather, or government restrictions.
        </p>
      </>
    ),
  },
...
const termsTopics = termsSections.map(({ id, title }) => ({ id, title }));
  ...
  return (
    <>
      <PageHero
        ...
        title="Clear terms for ordering and using Pexpacks online"
        text="These terms explain how Pexpacks handles quotes, orders, payments, school packs, Pexcover services, delivery, cancellations, and your use of the website and web app."
        panelTitle="Effective 18 May 2026"
        panelText="South Africa"
      />

      <section className={`${page.section} ${styles.termsSection}`}>
        <div className={`${page.sectionInner} ${styles.termsInner}`}>
          <PolicyContentBar
            ariaLabel="Terms of use table of contents"
            classNames={{
          ...
          <div className={styles.termsContent}>
            <div className={styles.summaryPanel}>
              <p className={styles.summaryKicker}>Quick legal overview</p>
              <h2>Before you order</h2>
              <p>
                Review your school, grade, items, contact details, and delivery
                information carefully before submitting an order or making
                payment. Customised school packs, Pexcover work, and special
                orders may carry limited cancellation or return rights once
                processing has started.
              </p>
              <div className={styles.highlightGrid}>
                <div className={styles.highlightCard}>
                  <strong>Policies to read</strong>
                  <span>
                    <Link href="/privacy-policy">Privacy Policy</Link>,{" "}
                ...
                <div className={styles.highlightCard}>
                  <strong>Form confirmation</strong>
                  <span>
                    Use clear consent wording before checkout, quote, contact,
                    Pexcover, and school-order submissions.
                  </span>
                </div>
              </div>
            </div>
            ...
            {termsSections.map((section) => (
              <article className={styles.termsCard} id={section.id} key={section.id}>
            ...
            <article className={styles.termsCard}>
              <div className={styles.sectionHeader}>
                ...
                <span>
                  The original legal draft included explicit acceptance wording
                  for order and enquiry submissions.
                </span>
              </div>
              <div className={styles.sectionBody}>
                <div className={styles.noticeBlock}>
                  ...
                  <p>
                    I confirm that I have read and agree to the Pexpacks Terms
                ...
                <div className={styles.noticeBlock}>
                  ...
                  <p>
                    ...
                    correct and that I agree to the Pexpacks Terms of Use,
                    Privacy Policy, Delivery Policy, and Returns and Refunds
                    Policy.
                  </p>
                </div>
                <p className={styles.legalNote}>
                  Important legal note: this page is a strong operational draft
                  for publication, but it should still be reviewed by a South
                  African legal professional once final payment, courier,
                  partnership, refund, registration, and VAT details are fully
                  settled.
                </p>
              </div>
            </article>
